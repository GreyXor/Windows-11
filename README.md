<img width="150" height="150" align="left" style="float: left; margin: 0 10px 0 0;" alt="MS-DOS logo" src="https://upload.wikimedia.org/wikipedia/commons/e/e6/Windows_11_logo.svg">   

# Windows 11 Source Code

This repo contains the original source-code and compiled binaries for MS-DOS v1.25 and MS-DOS v2.0, plus the source-code for Windows 11 developed by Microsoft and based on MS-DOS.
